...
checkType(c_string_copy, c"0123456789".substring(-1).type);
checkType(c_string_copy, c"0123456789".substring(5).type);
checkType(c_string_copy, c"0123456789".substring(6..9).type);
